...
$(".vacancy-card ._toggle").click(function() {
    $(this).parents(".vacancy-card").toggleClass("_active")
    $(this).parents(".vacancy-card").find(".vacancy-card__bottom").slideToggle()
})
...
let Visible = function(target) {
    ...
    if (targetPosition.bottom - 10 > windowPosition.top &&
        ...
        if(target.classList.contains("_number-animation")){
            window.odometerOptions = {
                format: 'd',
                duration: 5000,
            };

            let num = +target.getAttribute("data-end")
            setTimeout(function(){
